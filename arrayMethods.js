...
const totalPopulation  = populations.reduce(function(runningTotal, curElement, curIndex, wholeArray) {
  return runningTotal + curElement + curIndex + wholeArray
})

const reduced = populations.reduce((runningTotal, curElement, curIndex, wholeArray) => runningTotal + curElement + curIndex + wholeArray)
...
// const myStrongest = monsterInyourPocket.filter(monster => monster.CP > 200)
